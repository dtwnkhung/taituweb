...
const DataGroupUser = (props) => {
  ...
  const columns = [
    ...
    columnHelper.accessor('tenNhomNguoiDung', {
      header: () => 'Tên nhóm người dùng',
      cell: info => info.getValue(),
    }),
    columnHelper.accessor('danhSachNguoiDung', {
      header: () => 'Danh sách người dùng',
      cell: info => `${info.getValue()} , `,
    }),
    columnHelper.accessor('quyenNhomNguoiDung', {
      header: () => 'Quyền nhóm người dùng',
      cell: info => info.getValue(),
    }),
    columnHelper.accessor('ngayTao', {
      header: () => 'Ngày tạo',
      cell: info => info.getValue(),
    }),
  ]
