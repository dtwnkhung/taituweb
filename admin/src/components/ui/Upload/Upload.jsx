...
const Upload = React.forwardRef((props, ref) => {
	...
	const triggerMessage = msg => {
		toast.push(<Notification type="danger" duration={2000}>{msg || 'Tải lên thất bại!'}</Notification>, {
	...
	const renderChildren = () => {
		if (!draggable && !children) {
			return <Button disabled={disabled} onClick={e => e.preventDefault()}>Tải lên</Button>
		}

		if (draggable && !children) {
			return <span>Chọn hoặc kéo thả file cần tải lên vào đây</span>
		}
